...
typedef enum {
    ...
    EXCEPTION_DLOPEN_FAIL,
    EXCEPTION_EXTSYM_RESOLUTION_FAIL,
...
static const char *ErrorStrings[] = {
    ...
    [EXCEPTION_DLOPEN_FAIL]            = STRINGFY(EXCEPTION_DLOPEN_FAIL),
    [EXCEPTION_EXTSYM_RESOLUTION_FAIL] = STRINGFY(EXCEPTION_EXTSYM_RESOLUTION_FAIL),
